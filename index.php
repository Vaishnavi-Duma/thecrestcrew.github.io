...
<html lang="zxx">
    <head>
        <title>Top Food Products Exporter in India | The Crest Crew </title>
        <meta name="description" content="Looking for best food exporter in India? We specialize in exporting fruits, vegetables and spices. contact us for high-quality food exports globally.">
        <?php include './head.php'; ?>
        <link rel="canonical" href="https://www.thecrestcrew.com">
    </head>
    <body>
        ...
        <style>
            ...
            @media only screen and (max-width: 767px) {
                ...
                .mobile-slider .service-item:hover {
                    background-color: #FFFFFF;
                }
                .mobile-slider .service-slider .center {
                    /*background-color: #ffbe00;*/
                    background-color: #FFFFFF;
                    background-image: url(assets/images/crest-logo.png);
        ...
        <!--<script>
            $('.accordion > li:eq(0) a').removeClass('active');
        </script>-->

        <section class="service-area  mobile-slider">
            <div class="container">
                        ...
                        <div class="col-lg-12">
                                <div class="service-slider owl-theme owl-carousel">
                                    <div class="service-item">
                                        <a href="javascript:;">
                                            <img src="assets/images/crest-logo.png" alt="Service">
                                            <img class="service-shape" src="assets/images/slider/slider-1.jpg" alt="slider-1">
                                        </a>
                                    </div>
                                    <div class="service-item">
                                        <a href="javascript:;">
                                            <img src="assets/images/crest-logo.png" alt="Service">
                                            <img class="service-shape" src="assets/images/slider/slider-2.jpg" alt="slider-2">
                                        </a>
                                    </div>
                                    <div class="service-item">
                                        <a href="javascript:;">
                                            <img src="assets/images/crest-logo.png" alt="Service">
                                            <img class="service-shape" src="assets/images/slider/slider-3.jpg" alt="slider-3">
                                        </a>
                                    </div>
                                    
                                </div>
                                <div class="banner-content"  style="display:none;">
                                    <!--<h1>We are a global food export & import company in India</h1>-->
                                    <p>We export food including raw vegetables, fruits, spices & many more</p>
                                </div>
                            </div>
                    </div>
                </div>
        ...
        <section class="feature-area pb-70">
            <div class="container">
                <div class="section-title">
                    ...
                    <p>Looking for food exporter in India, The Crestcrew International, a global food export & import company in India, exports Fruits, Vegetables, Spices and other food products.</p>
                </div>
                <div class="row">
                    <div class="col-sm-6 col-lg-4">
                        <div class="feature-item">
                            <img src="assets/images/category/fruits.jpg" alt="Feature">
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="feature-item">
                            <img src="assets/images/category/vegetables.jpg" alt="Feature">
                            <div class="feature-inner">
                                <ul>
                                    <li>
                    ...
                    <div class="col-sm-6 offset-sm-3 offset-lg-0 col-lg-4">
                        <div class="feature-item">
                            <img src="assets/images/category/spices.jpg" alt="Feature">
                            <div class="feature-inner">
                                <ul>
                                    <li>
...
<!--                                <p>Restaurants range from inexpensive and informal lunching or dining places catering to people working nearby, with modest food served in simple settings at low prices.</p>-->
                        ...
                        <div class="service-item">
                            <div class="row">
                                <div class="col-sm-12 col-lg-12">
                                    <ul class="accordion">
                                        <li>
                                            <a><span>01.</span>Get Buyers for Your Food Products</a>
                                        ...
                                        <li>
                                            <a><span>02.</span>Best quality food trading services</a>
                                        ...
                                        <li>
                                            <a><span>03.</span>Global Presence</a>
                        ...
                        <div class="service-item">
                            <div class="row">
                                <div class="col-sm-12 col-lg-12">
                                    <ul class="accordion">
                                        <li>
                                            <a><span>04.</span>Market Analysis & Up-to-date Market Information</a>
                                        ...
                                        <li>
                                            <a><span>05.</span>Reliable & Trusted Services</a>
                                        ...
                                        <li>
                                            <a><span>06.</span>Save your time & cost for searching markets</a>
                ...
                <div class="service-slider owl-theme owl-carousel">
                    ...
                    <div class="service-item">
                        <a href="javascript:;">
                            <img src="assets/img/home-one/service3.png" alt="Service">
                            <img class="service-shape" src="assets/img/home-one/service-shape.png" alt="Service">
                            <h3>Variety of Spices and Tastes</h3>
                    ...
                    <div class="service-item">
                        <a href="javascript:;">
                            <img src="assets/img/home-one/service3.png" alt="Service">
                            <img class="service-shape" src="assets/img/home-one/service-shape.png" alt="Service">
                            <h3>Diversity of India and Indian Culture</h3>
        ...
        <section class="collection-area pb-100" style="display: none;">
            <div class="container">
                <div class="section-title">
