...
if ((isset($_POST['captchahide'])) && ($_POST['captchahide'] == "reCAPTCHASuccess")) {
    //$pgname = $_POST['pgname'];
    $cname = $_POST['nametext'];
    $cemail = $_POST['emailtext'];
    $countrycode = $_POST['countrycode'];
    $phoneno = $_POST['phonetext'];
    ...
    if (isset($_POST['category'])) {
        ...
        $title = 'Request/Enquiry Price for ' . $product . ' [' . $category . ']';
    } else {
        $title = 'Request/Enquiry Details';
    }

    // mail code
    $mail = new PHPMailer();
    $mail->IsHTML(true);
    $mail->Username = "crestcrew@dumainfoservice.com"; // your GMail user name
    $mail->Password = "CrestCrew@321*"; // your GMail password
    $mail->AddAddress('dumainfo2013@gmail.com');
                                                                                                ...
                                                                                                <tbody><tr style="padding:0;text-align:left;vertical-align:top;word-break:keep-all!important">
                                                                                                        <th style="Margin:0;color:#33373d;font-family:-apple-system,Helvetica,Arial,sans-serif;font-size:16px;font-weight:400;line-height:1.4;margin:0;padding:0;text-align:left;word-break:keep-all!important">
                                                                                                            ...
                                                                                                            <div style="border-bottom-style:dashed;border-bottom-width:2px;border-color:#cb202d;border-left-style:dashed;border-left-width:2px;border-right-style:dashed;border-right-width:2px;border-top-style:dashed;border-top-width:2px;margin-top:25px;padding:10px;word-break:keep-all!important">
                                                                                                                ...
                                                                                                                <p style="Margin:0;Margin-bottom:16px;color:#cb202d;font-family:-apple-system,Helvetica,Arial,sans-serif;font-size:15px;font-weight:600;line-height:1.5;margin:0;margin-bottom:0;padding:0;word-break:keep-all!important">
                                                                                                                    Country code : <span style="color:black;">' . $countrycode . '</span>
                                                                                                                </p>
                                                                                                                <p style="Margin:0;Margin-bottom:16px;color:#cb202d;font-family:-apple-system,Helvetica,Arial,sans-serif;font-size:15px;font-weight:600;line-height:1.5;margin:0;margin-bottom:0;padding:0;word-break:keep-all!important">
                                                                                                                    Mobile No : <span style="color:black;">' . $phoneno . '</span>
                                                                                                                </p>
                                                                                                                <p style="Margin:0;Margin-bottom:16px;color:#cb202d;font-family:-apple-system,Helvetica,Arial,sans-serif;font-size:15px;font-weight:600;line-height:1.5;margin:0;margin-bottom:0;padding:0;word-break:keep-all!important">
                                                                                                                    Company name : <span style="color:black;">' . $companyname . '</span>
                                                                                                                </p>
                                                                                                                <p style="Margin:0;Margin-bottom:16px;color:#cb202d;font-family:-apple-system,Helvetica,Arial,sans-serif;font-size:15px;font-weight:600;line-height:1.5;margin:0;margin-bottom:0;padding:0;word-break:keep-all!important">
    ...
    $mail_cust->Username = "crestcrew@dumainfoservice.com"; // your GMail user name
    $mail_cust->Password = "CrestCrew@321*"; // your GMail password
    $mail_cust->AddAddress($cemail);
    $mail_cust->AddReplyTo = '';
    $mail_cust->ReturnPath = '';
    $mail_cust->FromName = 'The Crestcrew International';
    $mail_cust->Subject = 'Response of ' . $title ;
    ...
    if ($mail_cust->Send()) {
        ...
        header('location:' . $pre_url . '?success=your request has been submitted successfully!!!');
    } else {
        header('location:' . $pre_url . '?error=Oops Something went wrong...mail not sent!!!');
        //header('location:send-enquiry.php?category=' . $category . '&&product=' . $product . '&&error=Oops Something went wrong...mail not sent!!!');
    }
} else {
    /*if (isset($_POST['category'])) {
        header('location:' . $pre_url . '&&error=Oops Something went wrong...Try again!!!');
    } else {
        header('location:' . $pre_url . '?error=Oops Something went wrong...Try again!!!');
    }*/
    header('location:' . $pre_url . '?error=Oops Something went wrong...Try again!!!');
    //header('location:send-enquiry.php?category=' . $category . '&&product=' . $product . '&&error=Oops Something went wrong...Try again!!!');
}
?>