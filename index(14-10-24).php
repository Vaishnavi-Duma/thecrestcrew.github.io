...
<html lang="zxx">
    <head>
        <title>The Crestcrew International | Home</title>
        ...
        <div class="container1">
        	...
        	<div id="myCarousel" class="carousel slide" data-ride="carousel">
        		...
        		<div class="carousel-inner">
        			...
        			<div class="item active web-view">
        						...
        						<div class="banner-area-three">
        							<div class="container1">
        								<div class="banner-content">
        									...
        									<!--<h1 style="font-size: 35px;">Hassle Free & Happening <br> Parties are</h1>
        									<p style="font-size: 25px;">Just a click away.!</p>
        									<div class="banner-btn-wrap">
        										<a class="cmn-btn" href="combos.php">Order Now</a>
        									</div>-->
        								</div>
        								<!--<div class="banner-img">
        									<img src="assets/images/slider/slider-1.jpg" style="max-width: 600px; height: 450px;">
        								</div>-->
        							</div>
        						</div>
        					</div>
        						...
        						<div class="banner-area-three">
        							<div class="container1">
        								<div class="banner-content">
        									...
        									<!--<h1 style="font-size: 35px;">Diwali</h1>
        									<p style="font-size: 25px;">Special Offer.!</p>
        									<div class="banner-btn-wrap">
        										<a class="cmn-btn" href="combos.php">Order Now</a>
        										<a class="banner-btn-two" href="#">Get Free Call</a>
        									</div>-->
        								</div>
        								<!--<div class="banner-img">
        									<img src="assets/images/slider/slider-2.jpg" style="max-width: 600px; height: 450px;">
        								</div>-->
        							</div>
        						</div>
        					</div>
        						...
        						<div class="banner-area-three">
        							<div class="container1">
        								<div class="banner-content">
        									...
        									<!--<h1 style="font-size: 28px;">Grab the Super Saver Offers</h1>
        									<p style="font-size: 20px;">Place an order.!</p>
        									<div class="banner-btn-wrap">
        										<a class="cmn-btn" href="offers.php">Click here</a>
        									</div>-->
        								</div>
        								<!--<div class="banner-img">
        									<img src="assets/images/slider/slider-3.jpg" style="max-width: 600px; height: 470px; ">
        								</div>-->
        							</div>
        						</div>
        					</div>
        ...
        <section class="feature-area pt-100 pb-70">
            <div class="container">
                <div class="section-title">
                    ...
                    <h4>Global Quality Food Exporter From India</h4>
